...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0EA5E9,50:6366F1,100:A855F7&height=200&section=header&text=Nazar%20Metenchuk&fontSize=60&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=React%20%2F%20Full-Stack%20Developer&descAlignY=55&descSize=20" width="100%" />
...
JWT auth with session tracking, drag-and-drop board, one-click project templates, and a Google-Drive-style file manager.
...
**Food-delivery platform** — restaurant discovery, persistent cart, real-time order tracking and a full checkout flow.
